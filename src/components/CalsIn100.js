...
class CalsIn100 extends Component {
  render() {
    return (
      <div>
        <label htmlFor="cals-in-100">Cals in 100g:</label><input onChange={(e) => this.props.changeC100(+e.target.value)} name="cals-in-100" type="text" value={this.props.calsIn100 || ''} />
      </div>
    );
  }
}
